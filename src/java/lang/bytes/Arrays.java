...
public final class Arrays {
  ...
  public static final int[] ZERO = CACHE[0];
  public static final int[]  ONE = CACHE[1];
  public static final int[]  TWO = CACHE[2];

  public static int[] valueOf(final long v) {
    if(0 <= v && v < MAX_CACHE)
      return CACHE[(int)v];
  ...
  public static int compare(final int[] ints, final int[] other) {
  ...
  public static int compare(final int[] ints, final BigInteger other, final int maxWidth) {
  ...
  public static int[] stripLeadingZeroes(final int[] ints, int strip) {
    final int len = ints.length;
  ...
  public static int[] stripLeadingZeroes(final int[] ints) {
    return stripLeadingZeroes(ints, 0);
  }

  public static byte[] stripLeadingZeroes(final byte[] bs) {
    int strip;
  ...
  public static int[] not(final int[] ints, final int[] maxValue) {
  ...
  public static int[] and(int[] longer, int[] shorter) {
  ...
  public static int[] or(int[] longer, int[] shorter) {
    if(longer.length < shorter.length) {
      int[] tmp = longer; longer = shorter; shorter = tmp;
    }
  ...
  public static int[] xor(int[] longer, int[] shorter) {
    if(longer.length < shorter.length) {
      int[] tmp = longer; longer = shorter; shorter = tmp;
    }
    if(longer.length == 0)
  ...
  public static int[] setBit(final int[] a, final int bit) {
  ...
  public static int[] clearBit(final int[] a, final int bit) {
  ...
  public static int[] flipBit(final int[] a, final int bit) {
    final int i = bit >>> 5, alen = a.length;
  ...
  public static int[] lshift(final int[] a, final int n, final int maxWidth) {
    if(n == 0)
      return a;
  ...
  public static int[] rshift(final int[] a, final int n, final int maxWidth) {
    final int alen = a.length, ints = n >>> 5;
    if(alen <= ints)
      return ZERO;
  ...
  public static int[] add(int[] longer, int[] shorter, final int maxWidth) {
    if(longer.length < shorter.length) {
      int[] tmp = longer;
      longer    = shorter;
      shorter   = tmp;
  ...
  public static int[] subgt(final int[] a, final int[] b, final int[] maxValue) {
    if(a.length == 0)
  ...
  public static int[] addmod(int[] a, int[] b, final int[] c) {
    if(a.length < b.length) {
      int[] tmp = a; a = b; b = tmp;
    }
  ...
  public static int[] multiply(int[] a, int[] b, final int maxWidth) {
    if(a.length < b.length) {
      int[] tmp = a; a = b; b = tmp;
    }
  ...
  public static int[] mul(int[] a, final int alen, int b, int maxWidth) {
  ...
  public static int[] square(final int[] a, final int maxWidth) {
  ...
  public static int[] pow(int[] a, final int lo, int exp, final int maxWidth) {
    if(exp == 2)
  ...
  public static int[][] divmod(final int[] a, final long b) {
  ...
  public static int[][] divmod(final int[] a, final int[] b) {
    final int[][] qr;
  ...
  public static int[] from(BigInteger b, final int maxWidth) {
  ...
  public static int[] from(final byte[] bytes, final int[] maxValue) {
  ...
  public static int[] maxValue(final int maxWidth) {
